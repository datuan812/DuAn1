...
public class ItemChartPie1 extends javax.swing.JPanel {

    private final ModelChartPie1 data;

    public ItemChartPie1(ModelChartPie1 data) {
        this.data = data;
        initComponents();
        setOpaque(false);
        DecimalFormat df = new DecimalFormat("#,##0.## Sản phẩm");
