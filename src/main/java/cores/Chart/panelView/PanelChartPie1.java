...
public class PanelChartPie1 extends javax.swing.JPanel {

    private final List<ModelChartPie1> list;
    private float chartSize = 0.5f;

    public PanelChartPie1() {
        initComponents();
        list = new ArrayList<>();
    ...
    public void addItem(ModelChartPie1 data) {
        list.add(data);
        repaint();
    }
